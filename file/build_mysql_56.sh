...
mysql_source_file=@mysql_flyme_file
...
f_install_mysql()
{
    yum -y install gcc gcc-c++ autoconf cmake perl-DBD-MySQL perl-DBI bison-devel ncurses-devel openssl-devel glibc readline-devel openssl openssl-devel ncurses ncurses-devel jemalloc-devel jemalloc libcurl-devel
    mkdir $source_dir
